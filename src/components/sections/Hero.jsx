  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-24 text-center relative z-10">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-5 animate-fade-in leading-tight">  <span>with Passion and Innovation</span> </h2>
        ...
        {/* Enhanced stats with subtle animations */}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-obsidian-black/80 to-transparent"></div>
    </section>
  );
};
